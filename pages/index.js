  ...
  return (
    <Layout title="Learn How To Vlog and Start Vlogging Today (FREE Guide and Lessons">
            ...
            <div className="flex-container flex-center">
              <div className="block block-copy margin--l-bottom">
                <div className="text-center">
                  <a href="/start/why-vlog/" alt="Get started with vlogging">
          ...
          <div className="animate" style={{ height: 500 }}>
            <div className="block margin--l-top flex-container">
              <div
                ...
                data-fadetime="500"
              >
                <img src="/wp-content/uploads/2017/11/cory-profile-less-large.png" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex-container flex-center">
            <div className="block block-copy">
              ...
              <p>
                ...
                have a
                <a href="https://youtube.com/corydhmiller" target="_blank">
                  weekly vlog
                </a>{' '}
          ...
          <div className="flex-container flex-center margin--l-top">
            <div className="block">
              <div className="massive font--bold">
                Vlogs are
                <div className="animate display--inline" style={{ height: 0 }}>
      ...
      <div className="row end-xs">
        <div className="endbar endbar-right margin--l-bottom"></div>
      </div>
          ...
          <div className="flex-container flex-center">
            <div className="block block-copy">
              ...
              <p>
                ...
                content I’d be making, how to get great quality…but actually, I
                wasn’t really doing anything but procrastinating.
              </p>
              ...
              <p>
                ...
                idea what my goals were, or why I even wanted to get started in
                the first place.
              </p>
              <p>
                Eventually I did get started. Now here I am, almost two years
                later, and the process of vlogging has become part of my weekly
                routine.
              </p>
            </div>
          </div>
            ...
            <div className="block block-copy">
              ...
              <p>
                ...
                <strong>
                  ...
                  consistent, and memorable vlog that keeps people coming back.
                </strong>
              </p>
              ...
              <div className="block block-copy">
                <div className="animate" style={{ height: 440 }}>
                  ...
                  >
                    ...
                    <img src="/wp-content/uploads/2017/11/episode1-before-e1524059701712.jpg" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="block block-copy">
                <div className="animate" style={{ height: 440 }}>
                  ...
                  >
                    ...
                    <img src="/wp-content/uploads/2017/11/episode118-after-e1524059667191.jpg" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex-container flex-center">
              <div className="block block-copy">
                ...
                <p>
                  ...
                  camera gear I use to shoot vlogs, and be notified each week
                  when a new lesson is available.
                </p>
      ...
      <div className="row">
        <div className="endbar endbar-full"></div>
      </div>
    </Layout>
  );
}
